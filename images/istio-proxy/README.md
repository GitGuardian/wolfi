...
| 📌 Version    | ⬇️ Pull URL                                         |
| ------------ | -------------------------------------------------- |
| latest       | ghcr.io/gitguardian/wolfi/istio-proxy:latest       |
| latest-dev   | ghcr.io/gitguardian/wolfi/istio-proxy:latest-dev   |
| latest-shell | ghcr.io/gitguardian/wolfi/istio-proxy:latest-shell |
| 1.25         | ghcr.io/gitguardian/wolfi/istio-proxy:1.25         |
| 1.25-shell   | ghcr.io/gitguardian/wolfi/istio-proxy:1.25-shell   |
| 1.25.1       | ghcr.io/gitguardian/wolfi/istio-proxy:1.25.1       |
| 1.25.1-shell | ghcr.io/gitguardian/wolfi/istio-proxy:1.25.1-shell |
...
gh attestation verify \
  --owner gitguardian \
  oci://ghcr.io/gitguardian/wolfi/istio-proxy:latest
```
...
gh attestation verify \
  --owner gitguardian \
  oci://ghcr.io/gitguardian/wolfi/istio-proxy:latest-shell
```
...
cosign verify \
  ...
  ghcr.io/gitguardian/wolfi/istio-proxy:latest | jq
```
...
cosign verify \
  --certificate-oidc-issuer=https://token.actions.githubusercontent.com \
  --certificate-identity=https://github.com/GitGuardian/wolfi/.github/workflows/release.yaml@refs/heads/main \
  ghcr.io/gitguardian/wolfi/istio-proxy:latest-shell | jq
```
...
cosign verify-attestation \
  ...
  --certificate-oidc-issuer=https://token.actions.githubusercontent.com \
  --certificate-identity=https://github.com/GitGuardian/wolfi/.github/workflows/release.yaml@refs/heads/main \
  ghcr.io/gitguardian/wolfi/istio-proxy:latest
```
...
cosign verify-attestation \
  ...
  --certificate-oidc-issuer=https://token.actions.githubusercontent.com \
  --certificate-identity=https://github.com/GitGuardian/wolfi/.github/workflows/release.yaml@refs/heads/main \
  ghcr.io/gitguardian/wolfi/istio-proxy:latest-shell
```

This will pull in the signature for the attestation specified by the --type parameter, which in this case is the SPDX attestation. You will receive output that verifies the SBOM attestation signature in cosign's transparency log:

```shell
Verification for ghcr.io/gitguardian/wolfi/istio-proxy:latest --
...
cosign download attestation \
  ...
  ghcr.io/gitguardian/wolfi/istio-proxy:latest | jq -r .payload | base64 -d | jq .predicate
```
...
cosign download attestation \
  --platform=linux/amd64 \
  --predicate-type=https://spdx.dev/Document \
  ghcr.io/gitguardian/wolfi/istio-proxy:latest-shell | jq -r .payload | base64 -d | jq .predicate
```
