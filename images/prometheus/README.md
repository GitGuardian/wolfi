...
| 📌 Version    | ⬇️ Pull URL                                        |
| ------------ | ------------------------------------------------- |
| latest       | ghcr.io/gitguardian/wolfi/prometheus:latest       |
| latest-shell | ghcr.io/gitguardian/wolfi/prometheus:latest-shell |
| 3.2          | ghcr.io/gitguardian/wolfi/prometheus:3.2          |
| 3.2-shell    | ghcr.io/gitguardian/wolfi/prometheus:3.2-shell    |
...
gh attestation verify \
  --owner gitguardian \
  oci://ghcr.io/gitguardian/wolfi/prometheus:latest
```
...
gh attestation verify \
  --owner gitguardian \
  oci://ghcr.io/gitguardian/wolfi/prometheus:latest-shell
```
...
cosign verify \
  ...
  ghcr.io/gitguardian/wolfi/prometheus:latest | jq
```
...
cosign verify \
  --certificate-oidc-issuer=https://token.actions.githubusercontent.com \
  --certificate-identity=https://github.com/GitGuardian/wolfi/.github/workflows/release.yaml@refs/heads/main \
  ghcr.io/gitguardian/wolfi/prometheus:latest-shell | jq
```
...
cosign verify-attestation \
  ...
  --certificate-oidc-issuer=https://token.actions.githubusercontent.com \
  --certificate-identity=https://github.com/GitGuardian/wolfi/.github/workflows/release.yaml@refs/heads/main \
  ghcr.io/gitguardian/wolfi/prometheus:latest
```
...
cosign verify-attestation \
  ...
  --certificate-oidc-issuer=https://token.actions.githubusercontent.com \
  --certificate-identity=https://github.com/GitGuardian/wolfi/.github/workflows/release.yaml@refs/heads/main \
  ghcr.io/gitguardian/wolfi/prometheus:latest-shell
```

This will pull in the signature for the attestation specified by the --type parameter, which in this case is the SPDX attestation. You will receive output that verifies the SBOM attestation signature in cosign's transparency log:

```shell
Verification for ghcr.io/gitguardian/wolfi/prometheus:latest --
...
cosign download attestation \
  ...
  ghcr.io/gitguardian/wolfi/prometheus:latest | jq -r .payload | base64 -d | jq .predicate
```
...
cosign download attestation \
  --platform=linux/amd64 \
  --predicate-type=https://spdx.dev/Document \
  ghcr.io/gitguardian/wolfi/prometheus:latest-shell | jq -r .payload | base64 -d | jq .predicate
```
